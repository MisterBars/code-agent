...
Отвечай только обычным текстом на русском языке.
Примеры кода оформляй в markdown-блоках с указанием языка:
```python
# код здесь
```
Никогда не возвращай Python-словари, JSON-объекты или сырые структуры данных как часть ответа.
"""
